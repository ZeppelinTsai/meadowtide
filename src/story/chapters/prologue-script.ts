...
export const PROLOGUE_SCRIPT: Record<string, DialogueLine[]> = {
  ...
  tour: [
    ...
    mayorWithoutPortrait(
      "「廣場西側，離廣場最近的那間店就是雜貨店。營業時間是上午十點到下午四點，星期一公休。」",
    ),
    mayorWithoutPortrait(
  ...
  day2: [
    ...
    mayor("「咦？有這麼嚴重嗎？我前幾天經過時還好好的……」"),
    carpenter("「表面看不出來才危險。」"),
    carpenter("「旁邊這兩塊也要換，底下的支撐最好一起檢查。」"),
    captain("「你才剛下船吧。」"),
    carpenter("「嗯。」"),
    captain("「行李都還在我手上。」"),
    "[歐文抬頭，這才想起自己是來報到的]",
    ...
    mayor("「差點忘了。那妳就是另一位申請來島上的藝術家吧？」"),
    artist("「嗯。我是露比，請多指教。」", { npcId: "artist", stage: 1 }),
    "[藝術家正式登場]",
    artist("「不過我覺得這裡挺漂亮的。」"),
    carpenter("「這裡？」"),
  ...
  fishing: [
    ...
    captain(
      "「都拿出來了，我就順便教你怎麼用吧。到南邊的沙灘試試，那裡比較安全。」",
    ),
    captain(
      "「竿子先裝備上，面向水邊按 E 甩出去就行。等魚上鉤，看提示按對就好，沒什麼難的。」",
    ),
    captain("「先試一次，我在旁邊看著。」"),
  ],
  fishingFailed: [
  ...
  cooking: [
    mayor("「說到吃的，我教你幾道菜當賠罪吧——烤蔬菜、海鮮湯，還有烤蘑菇串，先學這三道。」"),
    mayor("「爐灶就在屋子裡，一進門應該就找得到。走近它，挑一道你想做的試試看。」"),
    mayor(
